...
export function comptrollerFetchers() {
  return [
    ...
    new Fetcher<{ comptroller: Comptroller; cToken: XToken }, NumberV>(
      `
        #### CollateralFactor

        * "Comptroller CollateralFactor <XToken>" - Returns the collateralFactor associated with a given asset
    ...
    new Fetcher<
      { comptroller: Comptroller; account: AddressV; cToken: XToken },
      BoolV
    >(
      `
        #### CheckMembership
    ...
    new Fetcher<{ comptroller: Comptroller; cToken: XToken }, BoolV>(
      `
        #### CheckListed
    ...
    new Fetcher<{ comptroller: Comptroller; cToken: XToken }, BoolV>(
      `
        ...
        * "Comptroller CheckIsComped <XToken>" - Returns true if market is listed, false otherwise.
    ...
    new Fetcher<
      { comptroller: Comptroller; XToken: XToken; key: StringV },
      NumberV
    >(
      `
      ...
      [
        new Arg("comptroller", getComptroller, { implicit: true }),
        new Arg("XToken", getXTokenV),
        new Arg("key", getStringV),
      ],
      async (world, { comptroller, XToken, key }) => {
        const result = await comptroller.methods
          .compSupplyState(XToken._address)
          .call();
    ...
    >(
      ...
      async (world, { comptroller, XToken, key }) => {
        const result = await comptroller.methods
          .compBorrowState(XToken._address)
          .call();
        return new NumberV(result[key.val]);
      }
    ),
    ...
    >(
      ...
      async (world, { comptroller, account }) => {
        const result = await comptroller.methods
          .compReceivable(account.val)
          .call();
        return new NumberV(result);
      }
    ),
    new Fetcher<
      { comptroller: Comptroller; XToken: XToken; account: AddressV },
      NumberV
    >(
      `
        #### compSupplierIndex
      ...
      async (world, { comptroller, XToken, account }) => {
        return new NumberV(
          await comptroller.methods
            .compSupplierIndex(XToken._address, account.val)
            .call()
        );
      }
    ),
    ...
    >(
      ...
      async (world, { comptroller, XToken, account }) => {
        return new NumberV(
          await comptroller.methods
            .compBorrowerIndex(XToken._address, account.val)
            .call()
        );
      }
    ),
    new Fetcher<{ comptroller: Comptroller; XToken: XToken }, NumberV>(
      `
        #### CompSpeed
      ...
      async (world, { comptroller, XToken }) => {
        return new NumberV(
          await comptroller.methods.compSpeeds(XToken._address).call()
        );
      }
    ),
    new Fetcher<{ comptroller: Comptroller; XToken: XToken }, NumberV>(
      ...
      async (world, { comptroller, XToken }) => {
        return new NumberV(
          await comptroller.methods.compSupplySpeeds(XToken._address).call()
        );
      }
    ),
    new Fetcher<{ comptroller: Comptroller; XToken: XToken }, NumberV>(
      ...
      async (world, { comptroller, XToken }) => {
        return new NumberV(
          await comptroller.methods.compBorrowSpeeds(XToken._address).call()
        );
      }
    ),
    new Fetcher<{ comptroller: Comptroller }, AddressV>(
    ...
    new Fetcher<{ comptroller: Comptroller; XToken: XToken }, NumberV>(
      ...
      async (world, { comptroller, XToken }) => {
        return new NumberV(
          await comptroller.methods.borrowCaps(XToken._address).call()
        );
      }
    ),
    new Fetcher<{ comptroller: Comptroller; XToken: XToken }, NumberV>(
      ...
      async (world, { comptroller, XToken }) => {
        return new NumberV(
          await comptroller.methods.isDeprecated(XToken._address).call()
        );
      }
    ),
  ];
