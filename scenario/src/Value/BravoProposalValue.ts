...
async function getProposal(world: World, governor: GovernorBravo, proposalIdent: Event, getter: (govener: GovernorBravo, number: encodedNumber) => Promise<Event>): Promise<Event> {
