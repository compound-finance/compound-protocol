...
export interface XTokenMethods {
...
export interface XTokenScenarioMethods extends XTokenMethods {
  setTotalBorrows(amount: encodedNumber): Sendable<void>;
  setTotalReserves(amount: encodedNumber): Sendable<void>;
}

export interface XToken extends Contract {
  methods: XTokenMethods;
  name: string;
}

export interface XTokenScenario extends Contract {
  methods: XTokenScenarioMethods;
  name: string;
}
