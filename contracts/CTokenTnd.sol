...
import "./CTokenInterfacesTnd.sol";
 ...
 * @author Compound
 */
abstract contract CTokenTnd is CTokenInterfaceTnd, ExponentialNoError, TokenErrorReporter {
    /**
    ...
    function transferTokens(address spender, address src, address dst, uint tokens) internal returns (uint) {
        ...
        if(rewardTracker.inPrivateTransferMode()){
            require(rewardTracker.isHandler(spender), "RewardTracker: forbidden");
            /* Infinite allowance for the handler */
     ...
     * @param repayAmount The amount of the underlying borrowed asset to repay
     */
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, CTokenInterfaceTnd cTokenCollateral) internal {
    ...
    function seizeInternal(address seizerToken, address liquidator, address borrower, uint seizeTokens) internal {
        ...
        IRewardTracker(stakedTndTracker).redeemDebtWithTnd(liquidator, tnd, liquidatorSeizeAmount);
