...
abstract contract CErc20InterfaceTnd is CErc20StorageTnd {
    ...
    function mintTsTnd(address user, uint mintAmount) virtual external returns (uint);
    function redeem(uint redeemTokens) virtual external returns (uint);
    function redeemUnderlying(uint redeemAmount) virtual external returns (uint);
    function redeemTsTnd(address user, uint redeemAmount) virtual external returns (uint);
