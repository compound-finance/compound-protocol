[![CircleCI](https://circleci.com/gh/compound-finance/vortex-protocol.svg?style=svg&circle-token=5ed19932325c559a06f71f87d69012aedd2cf3fb)](https://circleci.com/gh/compound-finance/vortex-protocol) [![codecov](https://codecov.io/gh/compound-finance/vortex-protocol/branch/master/graph/badge.svg?token=q4UvsvVzOX)](https://codecov.io/gh/compound-finance/vortex-protocol)
...
* The [Vortex Whitepaper](https://vortex.finance/documents/Vortex.Whitepaper.pdf), describing how Vortex works
* The [Vortex Protocol Specification](https://github.com/compound-finance/vortex-protocol/tree/master/docs/VortexProtocol.pdf), explaining in plain English how the protocol operates

For questions about interacting with Vortex, please visit [our Discord server](https://vortex.finance/discord).

For security concerns, please visit [https://vortex.finance/security](https://vortex.finance/security) or email [security@vortex.finance](mailto:security@vortex.finance).

Contributing
============

Contributing to the Vortex protocol is a bit different than most open-source projects -- check out the [community guide on Contributing](https://www.vtx.xyz/t/contributing-to-vortex-protocol/48).
...
<dl>
  ...
  <dd>The administrator of the Vortex timelock contract. Holders of Vtx token may create and vote on proposals which will be queued into the Vortex timelock and then have effects on Vortex vToken and Controller contracts. This contract may be replaced in the future with a beta version.</dd>
</dl>
...
Installation
------------
To run vortex, pull the repository from GitHub and install its dependencies. You will need [yarn](https://yarnpkg.com/lang/en/docs/install/) or [npm](https://docs.npmjs.com/cli/install) installed.

    git clone https://github.com/compound-finance/vortex-protocol
    cd vortex-protocol
...
You can read more about the scenario runner in the [Scenario Docs](https://github.com/compound-finance/vortex-protocol/tree/master/scenario/SCENARIO.md) on steps for using the repl.

Testing
-------
Jest contract tests are defined under the [tests directory](https://github.com/compound-finance/vortex-protocol/tree/master/tests). To run the tests run:
...
There are additional tests under the [spec/scenario](https://github.com/compound-finance/vortex-protocol/tree/master/spec/scenario) folder. These are high-level integration tests based on the scenario runner depicted above. The aim of these tests is to be highly literate and have high coverage in the interaction of contracts.

Formal Verification Specs
-------------------------

The Vortex Protocol has a number of formal verification specifications, powered by [Certora](https://www.certora.com/). You can find details in the [spec/formal](https://github.com/compound-finance/vortex-protocol/tree/master/spec/formal) folder. The Certora Verification Language (CVL) files included are specifications, which when with the Certora CLI tool, produce formal proofs (or counter-examples) that the code of a given contract exactly matches that specification.
...
To run in docker:
    ...
    docker run -it vortex-protocol /bin/sh

From within a docker shell, you can interact locally with the protocol via ganache and truffle:

```bash
    /vortex-protocol > yarn console -n goerli
    Using network goerli https://goerli-eth.vortex.finance
    Saddle console on network goerli https://goerli-eth.vortex.finance
    Deployed goerli contracts
      controller: 0x627EA49279FD0dE89186A58b8758aD02B6Be2867
      vtx: 0xfa5E1B628EFB17C024ca76f65B45Faf6B3128CA5
    ...
    > await vtx.methods.totalSupply().call()
...
```bash
docker run --env ETHERSCAN_API_KEY --env VERIFY=true --env ACCOUNT=0x$(cat ~/.ethereum/rinkeby) vortexfinance/vortex-protocol:latest npx saddle -n rinkeby script token:deploy '{
  "underlying": "0x577D296678535e4903D59A4C929B718e1D575e0A",
  "controller": "$Controller",
  "interestRateModel": "$Base200bps_Slope3000bps",
  "initialExchangeRateMantissa": "2.0e18",
...
```bash
docker run --env ACCOUNT=0x$(cat ~/.ethereum/rinkeby) vortexfinance/vortex-protocol:latest npx saddle -n rinkeby script token:match 0xF1BAd36CB247C82Cb4e9C2874374492Afb50d565 '{
  "underlying": "0x577D296678535e4903D59A4C929B718e1D575e0A",
  "controller": "$Controller",
  "interestRateModel": "$Base200bps_Slope3000bps",
  "initialExchangeRateMantissa": "2.0e18",
...
For any concerns with the protocol, open an issue or visit us on [Discord](https://vortex.finance/discord) to discuss.

For security concerns, please email [security@vortex.finance](mailto:security@vortex.finance).

_© Copyright 2020, Vortex Labs_
