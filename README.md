...
For questions about interacting with Compound, please visit [our Discord server](https://discordapp.com/invite/874ntdw).

For information on audits, see the [Audits](https://github.com/compound-finance/compound-protocol/tree/master/audits) section.
...
There are additional tests under the [spec/scenario](https://github.com/compound-finance/compound-protocol/tree/master/spec/scenario/README.md) folder. These are high-level integration tests based on the scenario runner depicted above. The aim of these tests is to be highly literate and have high coverage in the interaction of contracts.

Formal Verification Specs
-------------------------

The Compound Protocol has a number of formal verification specifications, powered by [Certora](https://www.certora.com/). You can find details in the [spec/forma](https://github.com/compound-finance/compound-protocol/tree/master/spec/formal/README.md) folder. The Certora Verification Language (CVL) files included are specifications, which when with the Certora CLI tool, produce formal proofs (or counter-examples) that the code of a given contract exactly matches that specification.
...
License
-------
All code in this respository, unless otherwise stated, is copyright of Compound. The source code for this protocol is released only for auditing purposes. It is prohibited to modify and distribute this code without prior written authorization from Compound.
...
For any concerns with the protocol, visit us on [Discord](https://discordapp.com/invite/874ntdw) to discuss.
