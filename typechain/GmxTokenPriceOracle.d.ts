...
interface GmxTokenPriceOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class GmxTokenPriceOracle extends BaseContract {
  ...
  interface: GmxTokenPriceOracleInterface;
