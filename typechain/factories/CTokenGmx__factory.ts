...
import type { CTokenGmx, CTokenGmxInterface } from "../CTokenGmx";
...
export class CTokenGmx__factory {
  static readonly abi = _abi;
  static createInterface(): CTokenGmxInterface {
    return new utils.Interface(_abi) as CTokenGmxInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CTokenGmx {
    return new Contract(address, _abi, signerOrProvider) as CTokenGmx;
  }
}
