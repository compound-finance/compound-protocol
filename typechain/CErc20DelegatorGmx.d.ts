...
interface CErc20DelegatorGmxInterface extends ethers.utils.Interface {
  functions: {
    ...
    "approveGlpRewardRouterWETHSpending()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "approveGlpRewardRouterWETHSpending",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CErc20DelegatorGmx extends BaseContract {
  ...
  interface: CErc20DelegatorGmxInterface;
  ...
  functions: {
    ...
    approveGlpRewardRouterWETHSpending(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
