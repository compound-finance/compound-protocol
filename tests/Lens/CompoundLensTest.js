...
describe("CompoundLens", () => {
  ...
  describe("cTokenMetadata", () => {
    ...
    it("is correct for cEth", async () => {
      let cEth = await makeXToken({ kind: "cether" });
      expect(
    ...
    it("is correct for cErc20 with set comp speeds", async () => {
      ...
      let cErc20 = await makeXToken({ comptroller, supportMarket: true });
  ...
  describe("cTokenBalances", () => {
    it("is correct for xERC20", async () => {
      let cErc20 = await makeXToken();
      expect(
        cullTuple(
